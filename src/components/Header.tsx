            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between py-4">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="/#locations" className="text-gray-600 hover:text-gray-900 transition">
                            Locations
                        </Link>
                        <Link
                            href="/#how-it-works"
                    ...
                    <div className="hidden md:flex items-center gap-4 ">
                        {isAuthenticated ? (
                            <>
                                ...
                                <Button onClick={handleLogout} className="cursor-pointe transition-colors hover:bg-white hover:text-black hover:border-black">Log Out</Button>
                            </>
                        ) : (
                            <>
                                <Link href="/login">
                                ...
                                <Link href="/register" >
                                    <Button className="cursor-pointer cursor-pointer transition-colors hover:bg-white hover:text-black hover:border-black">Sign Up</Button>
                                </Link>
                            </>
                        )}
                    </div>
